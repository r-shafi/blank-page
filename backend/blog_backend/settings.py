...
DEFAULT_FROM_EMAIL = os.getenv(
    'DEFAULT_FROM_EMAIL', f'Blank Page <{os.getenv("EMAIL_HOST_USER", "admin@blankpage.com")}>')
ADMIN_EMAIL = os.getenv('ADMIN_EMAIL', os.getenv('EMAIL_HOST_USER', 'admin@blankpage.com'))
